...
import * as API from '@/services/materials';
...
export default function Page() {
  const defaultData: API.TMaterial = {
    id: '',
    name: '',
    slug: '',
  };
  ...
  } = useCrud<API.TMaterial>(API, defaultData);
  ...
  return <div>
    <Title text='Список матеріалів' size='xl' className='uppercase' />
